...
public class MovieSAXParser extends DefaultHandler {
    ...
    private void printData() {
        ...
        System.out.printf("%40s%d%n", "  Duplicate movies.Movie Id: ", inconsistentMoviesWithDuplicateMovieId.size());
        System.out.printf("%40s%d%n", "  Empty movies.Movie Title: ", inconsistentMoviesWithEmptyMovieTitle.size());
