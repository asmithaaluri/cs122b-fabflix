...
@WebServlet(name = "movies.MovieSearchServlet", urlPatterns = "/api/movies/search")
public class MovieSearchServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            if (claims == null) { // Invalid JWT token.
                System.out.println("Invalid token in MovieSerachServlet");
            ...
            // save search params
            claims.put("title", ptitle);
            claims.put("year", pyear);
            claims.put("director", pdirector);
            claims.put("star", pstar);

            // use existing sorting and movies per page
            String sort = (String) claims.getOrDefault("sort", "tu-rd");
            String moviesPerPage = (String) claims.getOrDefault("moviesPerPage", "25");
